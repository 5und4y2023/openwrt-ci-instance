...
sed -i '$a src/gz openwrt_kmods https://mirrors.vsean.net/openwrt/releases/24.10-SNAPSHOT/targets/mediatek/filogic/kmods/6.6.133-1-a8b93917f464536104594f27d870028d' /etc/opkg/distfeeds.conf
