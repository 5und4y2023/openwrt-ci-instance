...
if grep -Eq "mt7981=y" "$GITHUB_WORKSPACE/$CONFIG_FILE"; then
	mv $GITHUB_WORKSPACE/patch/hanwckf/199-diy-mt7981.sh package/base-files/files/etc/uci-defaults/za.sh
fi
if grep -Eq "mt7986=y" "$GITHUB_WORKSPACE/$CONFIG_FILE"; then
	mv $GITHUB_WORKSPACE/patch/hanwckf/199-diy-mt7986.sh package/base-files/files/etc/uci-defaults/za.sh
fi

if grep -Eq "frpc=y" "$GITHUB_WORKSPACE/$CONFIG_FILE"; then
	mv $GITHUB_WORKSPACE/patch/hanwckf/199-frp.sh package/base-files/files/etc/uci-defaults/za.sh
fi
